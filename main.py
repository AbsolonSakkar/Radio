...
class MusicWindow(App):
    ...
    def play_record(self, bl):
        music = vlc.MediaPlayer('https://air.radiorecord.ru:805/naft_128')
    ...
    def build(self):
        ...
        bl.add_widget( Button(text="Эхо Москвы", font_size = 26, size_hint = (1, .3), on_press = self.play_echo) )
